  ...
  <div class="quote-container">
    <div class="quote-data flex justify-between">
      ...
      <div class="basis-2/5">
        ...
        <div class="premium">Monthly: {{ format$(quoteData.monthlyPremium) }}</div>
        <div class="premium">Quarterly: {{ format$(quoteData.quarterlyPremium) }}</div>
        <div class="premium">Semi Annual: {{ format$(quoteData.semiannuallyPremium) }}</div>
        <div class="premium">Annual: {{ format$(quoteData.annuallyPremium) }}</div>
      </div>
      <div class="basis-1/5">
        <button
